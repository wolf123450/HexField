...
| `_pushItems` in syncService sent all messages/mutations in a single `sync_push`, exceeding the ~65 KB SCTP max message size | Fixed: `SYNC_PUSH_CHUNK_SIZE = 50` — items are batched into chunks of 50 before sending. |
