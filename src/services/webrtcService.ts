...
export class WebRTCService {
   ...
   */
  async addScreenShareTrack(sourceId: string, fps?: number, bitrateKbps?: number, useNewPipeline?: boolean, inlinePreview?: boolean, downscaleMethod?: string): Promise<void> {
